...
- [buildDomainPattern](functions/buildDomainPattern.md)
- [buildSegmentPattern](functions/buildSegmentPattern.md)
- [domainRegex](functions/domainRegex.md)
- [getDomainConstraints](functions/getDomainConstraints.md)
