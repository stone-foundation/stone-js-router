...
```ts
optional adapter?: Partial<AdapterConfig<any, any, any, IncomingEventType, any, OutgoingResponse>>;
```
...
```ts
optional adapters?: AdapterConfig<any, any, any, IncomingEventType, any, OutgoingResponse>[];
```
...
```ts
optional kernel?: KernelConfig<IncomingEventType, OutgoingResponse>;
```
...
```ts
optional lifecycleHooks?: LifecycleHookType<IBlueprint<any>, any, any, IncomingEventType, OutgoingResponse>;
```
...
```ts
optional middleware?: MixedPipe<IncomingEventType, OutgoingResponse>[];
```
